                ...
                if (u) {
                  if (y) {
                    for (; c; ) {
                      for (s = e; (s = s[c]); )
                        if (
                          x ? s.nodeName.toLowerCase() === h : 1 === s.nodeType
                        )
                          return !1;
  ...
  E.ajaxSetup({
    ...
    E.ajaxPrefilter("json jsonp", function(e, t, n) {
      ...
      if (s || "jsonp" === e.dataTypes[0])
        return (
          (i = e.jsonpCallback = x(e.jsonpCallback)
            ? e.jsonpCallback()
            : e.jsonpCallback),
          s
    ...
    E.each({ Height: "height", Width: "width" }, function(s, a) {
      E.each({ padding: "inner" + s, content: a, "": "outer" + s }, function(
        i,
        o
      ) {
        E.fn[o] = function(e, t) {
    ...
    function a(e, t) {
      ...
      (this.getDocumentScrollOffset = function() {
        ...
        (this.updateScrollBar = function(e) {
          ...
          if (x.ishwscroll)
            x.rail.css({
              height:
                x.win.innerHeight() - (_.railpadding.top + _.railpadding.bottom)
            }),
              x.railh &&
                x.railh.css({
                  width:
                ...
                (x.ontouchstartCursor = function(e, t) {
                  if (!x.rail.drag || 3 == x.rail.drag.pt) {
                    ...
                    return (
                      ...
                      x.isiframe &&
                        !b.hasmousecapture &&
                        ((x.saved.csspointerevents = x.doc.css(
                          "pointer-events"
                        )),
      ...
      if (b.haseventlistener) {
        ...
        (Event.prototype.preventDefault = function() {
          ...
          (L.constructor.prototype.addEventListener = N.constructor.prototype.addEventListener = Element.prototype.addEventListener = function(
            e,
            t,
            n
          ) {
          ...
          (L.constructor.prototype.removeEventListener = N.constructor.prototype.removeEventListener = Element.prototype.removeEventListener = function(
            e,
            t,
            n
          ) {
