# Generated by Django 3.0.4 on 2020-04-04 20:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='appname_and_image',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('app_name', models.CharField(max_length=120)),
                ('app_icon', models.ImageField(blank=True, upload_to='icon/')),
            ],
        ),
        migrations.CreateModel(
            name='temp',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keystore_link', models.CharField(default='/dashboard/', max_length=120)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
